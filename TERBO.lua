...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TERBOTEAM/Files_TERBO/master/File_Bot/commands.lua") 
...
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
tonumber(947425342) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
tonumber(1726705278) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
send(chat,msg.id_,"\n ❃∫ تم رفع الملف بنجاح وتفعيل المجموعه ات\n ❃∫ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
...
{'تنظيف المجموعه ات ❃','تنظيف المشتركين ❃'},
{'جلب نسخه الاحتياطيه ❃'},
...
os.execute('wget https://raw.githubusercontent.com/TERBOTEAM/TERBO/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس تربو\n ❃∫ الاصدار » { 1.3v}')
dofile('TERBO.lua')  
end
if text == 'الاصدار ❃' and DevTERBOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس تربو \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevTERBOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/ter_bo7) \n ❃∫ [قناه السورس](t.me/ter_bo7)')
end
...
if text == 'المجموعه ات ❃' and DevTERBOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المجموعه ات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == "تنظيف المجموعه ات ❃" and DevTERBOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد المجموعه ات الان » { '..#group..' }'..TERBOk..''..TERBO..'\n❃∫  الان عدد المجموعه ات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' ❃∫ تم تعيين عدد الاعضاء سيتم تفعيل المجموعه ات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevTERBOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if t2.id_ then 
name_TERBO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_TERBO then 
names_TERBO = database:smembers(bot_id.."TERBO:blocname"..msg.chat_id_) or ""
if names_TERBO and names_TERBO[1] then 
for i=1,#names_TERBO do 
if name_TERBO:match("(.*)("..names_TERBO[i]..")(.*)") then 
...
function amir_TERBOa_new(TERBO1,TERBO2)
if TERBO2 and TERBO2.first_name_ then 
if TERBO2.first_name_:match("(.*)"..database:get(bot_id.."TERBO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."TERBO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local TERBO_nnn = database:get(bot_id.."TERBO:nump"..msg.chat_id_) or 5
local TERBO_nnn2 = database:get(bot_id.."TERBO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(TERBO_nnn2) == tonumber(TERBO_nnn) or tonumber(TERBO_nnn2) > tonumber(TERBO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."TERBO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..TERBO2.username_.."](https://t.me/"..(TERBO2.username_ or "BO6OK")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."TERBO:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(TERBO_nnn) - tonumber(TERBO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_TERBOa_new)
end
end
...
Text = [[
  ...
  ↬ .TERBO TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/SIRIA199)  
  
  ↬ . [DEVELOPER](t.me/ALMOFTARESs)   
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BO6OK')..')'
status  = '\n ❃∫ تم الغاء (الحظر-الكتم) عام من المجموعه ات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if DevTERBOW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TERBOTEAM/Files_TERBO/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات تربو\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝘽𝙆━━━━━━≫\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/TERBOTEAM/Files_TERBO/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('TERBO.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس تربو \n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تربو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تربو')
local TERBO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تربو').." غادر" or text == 'غادر' then  
...
if text == 'المجموعه ات' then
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' ❃∫ عدد المجموعه ات » {`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
end
return false
end
...
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع صيح معرفات المجموعه ات') 
return false  
end
if result.id_ then
...
zh = https.request('https://rudi-dev.tk/Amir1/TERBO.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/TERBO.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/TERBO.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تربو')
